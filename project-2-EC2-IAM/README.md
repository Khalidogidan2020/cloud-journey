...
In this project, I will demonstrate how to use the AWS Identity and Access Management (IAM) service to control who is authenticated (signed in) and how to grant other users restricted access to my AWS account. The aim of this project is learn more about EC2 and IAM.
